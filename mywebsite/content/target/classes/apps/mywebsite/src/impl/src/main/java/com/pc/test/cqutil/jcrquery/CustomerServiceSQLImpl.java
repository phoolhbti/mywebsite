...
protected final Logger log = LoggerFactory.getLogger(this.getClass());
    public int injestCustData(String firstName, String lastName, String phone, String desc)
    {
            ...
            ServiceReference factoryRef = bundleContext.getServiceReference(DataSourcePool.class.getName());
            DataSourcePool dataSourcePool= (DataSourcePool) bundleContext.getService(factoryRef);
             try {
        ds = (DataSource) dataSourcePool.getDataSource("mysql");
    } catch(DataSourceNotFoundException e) {
        log.error("DataSourceNotFoundException while getting DataSource {}.", "mysql", e);
    }
