  ...
  while ( nodeIter.hasNext() ) {
    ...
    cust = new Customer(); 
     ...
     javax.jcr.Node node = nodeIter.nextNode();
        log.info("node.Node value: " +node.getProperty("firstName").getString());         
     ...
     cust.setCustDescription(node.getProperty("desc").getString());
          log.info("node.Node desc: " +node.getProperty("desc").getString());        
...
try {
  ...
  log.info(" result.getWriter().toString():::::"+ result.getWriter().toString()); 
