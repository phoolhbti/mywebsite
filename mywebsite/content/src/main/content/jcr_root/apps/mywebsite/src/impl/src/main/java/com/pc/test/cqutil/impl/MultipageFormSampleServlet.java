...
import com.pc.test.cqutil.multipageform.FormPage;
...
public class MultipageFormSampleServlet extends SlingAllMethodsServlet implements OptingServlet, Filter {
    ...
    @Property(value = "mywebsite/components/multipageform")
    ...
    static final String ATTR_RESOURCE = "mywebsite/components/multipageform/resource";
    ...
    protected void doPost(SlingHttpServletRequest request, SlingHttpServletResponse response) throws ServletException, IOException {
        ...
        while (fields.hasMoreElements()) {
            ...
            request.setAttribute("mywebsite/components/multipageform/form/" + field, request.getParameter(field));
        }
        ...
        request.setAttribute("mywebsite/components/multipageform/form/displayPage", displayPage);
