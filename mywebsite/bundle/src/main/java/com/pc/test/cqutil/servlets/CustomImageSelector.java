...
{@Property(name = Constants.SERVICE_DESCRIPTION, value = "Custom Image Selector"),
 ...
 @Property(name = "sling.servlet.resourceTypes", value = {"/content/dam/bandn/home/Koala","foundation/components/parbase", "cq:Page", "mywebsite/components/custom-rich-content" }),
...
@Override
 ...
 layer.drawText(10, 10, 500, 600, "wtih in invokeSelector1 ", font, Font.ALIGN_LEFT, 0, 0);
 } else if(selectors.contains("invokeSelector2")){
 int bgWidth = 150;
 Font font = new Font("Arial", 20);
 layer = new Layer(500, 600, Color.WHITE);
 layer.drawText(10, 10, 500, 600, "wtih in invokeSelector2 ", font, Font.ALIGN_LEFT, 0, 0);
 }
 else{
 int bgWidth = 150;
 Font font = new Font("Arial", 30);
 layer = new Layer(500, 600, Color.WHITE);
 layer.drawText(10, 10, 500, 600, "wtih in invokeSelector3 ", font, Font.ALIGN_LEFT, 0, 0);
 }
 return layer;
}
}